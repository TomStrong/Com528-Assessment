...
<%
    ...
    String cardno = propertiesDao.getProperty("org.solent.ood.simplepropertiesdaowebapp.cardno");
    String message = "";
    ...
    if ("updateProperties".equals(action)) {
        ...
        propertiesDao.setProperty("org.solent.ood.simplepropertiesdaowebapp.cardno", cardno);
...
<html>
    ...
    <body>
        ...
        <form action="./propertiesExample.jsp" method="POST">
            ...
            <p>Cardno Property <input type="text" name="cardno" value="<%=cardno%>"></p>
